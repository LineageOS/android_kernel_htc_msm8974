...
enum ABS_status {
	...
	ABS_LIGHT_Z = 0x0C,
	/*ABS_PROXIMITY_X = 0x0D,
	ABS_PROXIMITY_Y = 0x0E,
	ABS_PROXIMITY_Z = 0x0F,*/
...
#define CWSTM32_READ_SENSOR_BUFFERED_TRANSPORT			0x3C // (CW_MCU_I2C_SENSORS_REG_START + SENSOR_BUFFERED_TRANSPORT)
#define CWSTM32_READ_SENSOR_REALTIME_TRANSPORT			0x3D // (CW_MCU_I2C_SENSORS_REG_START + SENSOR_REALTIME_TRANSPORT)
#define CWSTM32_READ_SENSOR_TRANSPORT_BUFFER_FULL		0x3E // (CW_MCU_I2C_SENSORS_REG_START + SENSOR_TRANSPORT_BUFFER_FULL)

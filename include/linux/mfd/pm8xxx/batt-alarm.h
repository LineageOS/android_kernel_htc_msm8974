 ...
 * RETURNS: an appropriate -ERRNO error value on error, or zero for success.
 */
int pm8xxx_batt_alarm_state_set(int enable_lower_comparator, int enable_upper_comparator);
...
static inline int pm8xxx_batt_lower_alarm_register_notifier(void (*callback)(int))
{ return -ENODEV; }

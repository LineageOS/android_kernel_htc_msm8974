...
const unsigned char MIN_TX_TONE_VAL;
const unsigned char MAX_TX_TONE_VAL;
const unsigned char MIN_HARD_MUTE_VAL;
const unsigned char MAX_HARD_MUTE_VAL;
const unsigned char MIN_SRCH_MODE;
const unsigned char MAX_SRCH_MODE;
const unsigned char MIN_SCAN_DWELL;
const unsigned char MAX_SCAN_DWELL;
const unsigned char MIN_SIG_TH;
const unsigned char MAX_SIG_TH;
const unsigned char MIN_PTY;
const unsigned char MAX_PTY;
const unsigned short MIN_PI;
const unsigned short MAX_PI;
const unsigned char MIN_SRCH_STATIONS_CNT;
const unsigned char MAX_SRCH_STATIONS_CNT;
const unsigned char MIN_CHAN_SPACING;
const unsigned char MAX_CHAN_SPACING;
const unsigned char MIN_EMPHASIS;
const unsigned char MAX_EMPHASIS;
const unsigned char MIN_RDS_STD;
const unsigned char MAX_RDS_STD;
const unsigned char MIN_ANTENNA_VAL;
const unsigned char MAX_ANTENNA_VAL;
const unsigned char MIN_TX_PS_REPEAT_CNT;
const unsigned char MAX_TX_PS_REPEAT_CNT;
const unsigned char MIN_SOFT_MUTE;
const unsigned char MAX_SOFT_MUTE;
const unsigned char MIN_PEEK_ACCESS_LEN;
const unsigned char MAX_PEEK_ACCESS_LEN;
const unsigned char MIN_RESET_CNTR;
const unsigned char MAX_RESET_CNTR;
const unsigned char MIN_HLSI;
const unsigned char MAX_HLSI;
const unsigned char MIN_NOTCH_FILTER;
const unsigned char MAX_NOTCH_FILTER;
const unsigned char MIN_INTF_DET_OUT_LW_TH;
const unsigned char MAX_INTF_DET_OUT_LW_TH;
const unsigned char MIN_INTF_DET_OUT_HG_TH;
const unsigned char MAX_INTF_DET_OUT_HG_TH;
const signed char MIN_SINR_TH;
const signed char MAX_SINR_TH;
const unsigned char MIN_SINR_SAMPLES;
const unsigned char MAX_SINR_SAMPLES;
